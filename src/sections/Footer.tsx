...
export const Footer = () => {
  return (
    <footer className="bg-transparent pt-16 pb-10 px-6 md:px-20 border-t border-slate-100/50 relative z-10">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-14">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-nodal-graphite text-xs font-light leading-relaxed mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 col-span-1 md:col-span-3 gap-6">
            <div>
              <h4 className="font-semibold text-nodal-blue text-sm mb-4">Product</h4>
              <ul className="space-y-3 text-xs text-nodal-graphite font-light">
            ...
            <div>
              <h4 className="font-semibold text-nodal-blue text-sm mb-4">Company</h4>
              <ul className="space-y-3 text-xs text-nodal-graphite font-light">
            ...
            <div>
              <h4 className="font-semibold text-nodal-blue text-sm mb-4">Legal</h4>
              <ul className="space-y-3 text-xs text-nodal-graphite font-light">
